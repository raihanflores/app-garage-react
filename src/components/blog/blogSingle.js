                                ...
                                <ul>
                                    <li>
                                        <div className="media align-self-center">
                                            <img className="align-self-center" src={comment} alt="Generic placeholder image" />
                                    ...
                                    <li>
                                        <ul>
                                            <li>
                                                <div className="media">
                                                    <img className="align-self-center" src={nine} alt="Generic placeholder image" />
                                                    <div className="media-body">
                                                        <div className="row">
                                    ...
                                    <li>
                                        <div className="media">
                                            <img className="align-self-center" src={four} alt="Generic placeholder image" />
                                            <div className="media-body">
                                                <div className="row">
                                                    <div className="col-md-4">
                                                        <h6 className="mt-0">Jolio Mark<span> ( Designer )</span></h6>
                                    ...
                                    <li>
                                        <div className="media">
                                            <img className="align-self-center" src={twelve} alt="Generic placeholder image" />
                                            <div className="media-body">
                                                <div className="row">
                                                    <div className="col-md-4">
                                                        <h6 className="mt-0">Jolio Mark<span> ( Designer )</span></h6>
                                    ...
                                    <li>
                                        <div className="media">
                                            <img className="align-self-center" src={fourteen} alt="Generic placeholder image" />
                                            <div className="media-body">
                                                <div className="row">
                                                    <div className="col-md-4">
                                                        <h6 className="mt-0">Jolio Mark<span> ( Designer )</span></h6>
