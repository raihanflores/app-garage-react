            ...
            <div className="row">
              <div className="col-md-6 products-total">
                <div className="square-product-setting d-inline-block">
                  <a className="icon-grid grid-layout-view " onClick={gridLayout} data-original-title="" title="">
                    <Grid />
                  </a>
                </div>
                <div className="square-product-setting d-inline-block">
                  <a className="icon-grid m-0 list-layout-view" onClick={listLayout} data-original-title="" title="">
                    <List />
                  </a>
                </div>
                ...
                <div className="grid-options d-inline-block">
                  <ul>
                    <li>
                      <a className="product-2-layout-view" onClick={() => LayoutView(6)} data-original-title="" title="">
                        <span className="line-grid line-grid-1 bg-primary"></span>
                        <span className="line-grid line-grid-2 bg-primary"></span>
                      </a>
                    </li>
                    <li>
                      <a className="product-3-layout-view" onClick={() => LayoutView(4)} data-original-title="" title="">
                    ...
                    <li>
                      <a className="product-4-layout-view" onClick={() => LayoutView(3)} data-original-title="" title="">
                    ...
                    <li>
                      <a className="product-6-layout-view" onClick={() => LayoutView(2)} data-original-title="" title="">
                    ...
                    <div className="card" >
                      <div className="product-box">
                        ...
                        <div className="product-details">
                          <h5>
                            <a onClick={() => onClickDetailPage(item)} className="font-primary">
                              {item.name}
                            </a></h5>
                      ...
                      <div className="product-details col-md-6 text-left">
                        ...
                        <div className="product-qnty">
                          ...
                          <div className="addcart-btn">
                            ...
                            <button className="btn btn-success" type="button">View Details</button>
                          </div>
                        </div>
                      </div>
                    </div>
